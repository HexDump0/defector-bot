// Defector research candidate v4 — current-population contrite classifier.
// Tuned on the 2026-09-04T12:42:12Z active snapshot for mean points/round.
// State is constant-size and JSON-safe; the strategy has no end-round assumption.
